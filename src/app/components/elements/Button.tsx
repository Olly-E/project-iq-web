...
export const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <Tag
      ...
      className={clsx(
        className,
        "justify-center font-normal whitespace-nowrap w-fit focus:outline-blue-state disabled:cursor-not-allowed gap-2 disabled:opacity-70 cursor-pointer flex items-center transition-colors duration-100",
